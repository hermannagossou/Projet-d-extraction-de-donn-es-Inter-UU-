    ...
    for index_df in dict_df:
        if index_df == 'Données':
            ...
            if len(CHAINE)==0:
                ...
                BPEU=CHAINE[CHAINE.str.contains('^BPEU[0-9]|^BPEA[0-9]|^BPP[0-9]|^BPI[0-9]|^BPEI[0-9]|^BPE-V|^SI[0-9]{6}',na=False)]
                ...
                SUPPORTS=CHAINE[CHAINE.str.contains('ORF_|BYT_|NXL_|COL_|OPE_|NEX_|POL|ATC_|OPT_|^T[A-Za-z0-9]{5}',na=False)]
